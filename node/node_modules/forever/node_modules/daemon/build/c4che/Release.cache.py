...
CPPPATH_NODE = '/private/opt/local/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/mac/.node_libraries'
LIBPATH_NODE = '/private/opt/local/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/mac/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/private/opt/local'
