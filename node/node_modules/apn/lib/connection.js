...
Connection.prototype.pushNotification = function (notification, recipient) {
	if (!this.validNotification(notification[0], recipient)) {
		console.log("!this.validNotification");
		return;
	}
	if (sysu.isArray(recipient)) {
		for (var i = recipient.length - 1; i >= 0; i--) {
			...
			this.bufferNotification({ "notification": notification[i], "recipient": device });
			console.log(recipient[i]);
			console.log("bufferNotification");
		}
	}
	else {
